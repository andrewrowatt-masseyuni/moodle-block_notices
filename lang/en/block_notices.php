...
$string['edittitle'] = 'Edit notice title';
$string['editupdatedescription'] = 'Edit update description';
$string['errorfieldtoolong'] = 'Value cannot exceed 64 characters.';
$string['errornopermission'] = 'You do not have permission to manage this notice.';
$string['errortitlerequired'] = 'Title cannot be empty.';
...
$string['newtitlefor'] = 'New title for {$a}';
$string['newupdatedescriptionfor'] = 'New update description for {$a}';
