...
$string['autoclose_email_body'] = 'The notice "{$a->title}" was automatically closed on {$a->closedate} because its scheduled close date had passed. It is now hidden. You can edit the notice and re-open it if needed.';
$string['autoclose_email_subject'] = 'Notice "{$a->title}" auto-closed';
...
$string['closedate_help'] = 'Optional. When set, a scheduled task will automatically hide this notice once the date and time has passed. The close date is cleared after the notice is closed.';
...
$string['event_notice_auto_closed'] = 'Notice auto-closed';
$string['event_notice_auto_closed_desc'] = 'The notice with id \'{$a->objectid}\' was automatically closed by the auto-close scheduled task.';
...
$string['image'] = 'Image';
$string['image_help'] = 'A single image with maximum height or width of 200px. The image is treated as decorative and hidden from screen readers, so any essential text or information it contains must also appear in the notice itself.';
...
$string['privacy:metadata:filearea_image'] = 'Optional image attached to a notice.';
...
$string['task_auto_close_notices'] = 'Auto-close notices with a passed close date';
$string['title'] = 'Title';
