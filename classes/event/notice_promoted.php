...
/**
 * Event notice_promoted
 *
 * @package    block_notices
 * @copyright  2026 Andrew Rowatt <A.J.Rowatt@massey.ac.nz>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class notice_promoted extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('event_notice_promoted', 'block_notices');
    }
    ...
    public function get_description() {
        ...
        return get_string('event_notice_promoted_desc', 'block_notices', $obj);
    }
